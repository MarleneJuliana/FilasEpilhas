                ...
                switch (opcao) {
                    case 1:
                        try {
                            ...
                            int indicePilha = Integer.parseInt(JOptionPane.showInputDialog(null, "Digite o número da pilha (1-5):", "Adicionar Produto", JOptionPane.QUESTION_MESSAGE)) - 1;

                            Produto produto = new Produto(codProduto, descricao, dataEntrada, ufOrigem, ufDestino);
                            deposito.adicionarProduto(indicePilha, produto);
                        } catch (Exception e) {
                    ...
                    case 3:
                        try {
                            int indicePilha = Integer.parseInt(JOptionPane.showInputDialog(null, "Digite o número da pilha (1-5):", "Retirar Produto", JOptionPane.QUESTION_MESSAGE)) - 1;
                            deposito.retirarProduto(indicePilha);
                        } catch (Exception e) {
                            JOptionPane.showMessageDialog(null, "Índice de pilha inválido. Tente novamente.");
                        }
                        break;
                    case 4:
